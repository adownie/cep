...
if($myposts!="") {
	...
	foreach($myposts as $post){ 
		...
		$images .= '<img src="'. bfi_thumb($post['image'], array( 'width' => 980, 'height' => $slider_height ) ) .'" alt="" >';
...
<div class="glass-general-frame" style="height:<?php echo $slider_height; ?>px;">
    ...
    <div class="glass-hover-2" style="height:<?php echo $slider_height; ?>px;">
    	...
    	<div class="glass-arrows-right icon-angle-right"></div>
    	<div class="glass-arrows icon-angle-left"></div>
    	<div class="glass-arrows-pause icon-pause"></div>
    	<div class="glass-arrows-play icon-play"></div>
