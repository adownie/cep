...
Description: Adds the ability to add multiple post thumbnails to a post type. Modified for use in BigBangWP
Version: 9.9.9
Author: Chris Scott, modified by Brankic1979
...
function update_extra_images_fields( $post_id ) {
...
add_action( 'save_post', 'update_extra_images_fields' );
?>